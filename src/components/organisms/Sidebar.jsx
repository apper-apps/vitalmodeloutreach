...
{/* Desktop Sidebar */}
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 z-sidebar">
        <div className="flex flex-col flex-1 bg-gradient-to-b from-primary-600 to-primary-700">
          <div className="flex items-center flex-shrink-0 px-6 py-6">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mr-3">
              <ApperIcon name="Sparkles" size={20} className="text-primary-600" />
            </div>
      ...
      {isOpen && (
        <div className="lg:hidden">
          <div className="fixed inset-0 z-mobile-overlay flex">
            <div className="fixed inset-0 bg-black bg-opacity-50" onClick={onClose} />
            <div className="relative flex flex-col w-64 bg-gradient-to-b from-primary-600 to-primary-700 transform translate-x-0 transition-transform duration-300 ease-in-out z-mobile-sidebar">
